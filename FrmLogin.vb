                    ...
                    If dsCRMDetails_Local.Tables(0).Rows(0)("HDDList") <> "" Then 'Fix PCs = Compare HDD Number
                        For Each mo As ManagementObject In mos.Get()
                            ...
                            Select Case Trim(serial)
                                Case "20246G446307", "WD-WCAV9CF21761", "1806AD806956", "30023210682", "11ENC2L7T", "JA1086SB03MB9T", "00A0_7501_325D_8688.", "S3T6NX0KB57755", "0026111030DS", "UB202309221900000242", "UB202309221900000242", "WD-WXC1EC85608S", "3000_0000_0000_0000_0000_0000_0000_0000.", "E823_8FA6_BF53_0001_001B_448B_4B73_D7B0."
                                    ssdPC = True
                                    flag = True
                                    Exit Select
                            End Select
...
#Region "Events"
    ...
    Private Sub txtUserName_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtUserName.LostFocus, txtPwd.LostFocus, cmbDept.LostFocus
        'SplashScreen1.Hide()
    ...
    Private Sub UpdateConpathToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles UpdateConpathToolStripMenuItem.Click
        FrmHelpConpath.ShowDialog()
    End Sub
    ...
    Private Sub SQLInstalltionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SQLInstalltionToolStripMenuItem.Click
        FrmSQLSetup.Show()
    End Sub
